...
function EmployeeLayout() {
    ...
    const icons = {
        ...
        password: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/><circle cx="12" cy="16" r="1"/></svg>,
    ...
    const navLinks = [
        ...
        { to: "/employee/profile", label: "My Profile", icon: icons.profile },
        { to: "/employee/my-tasks", label: "My Tasks", icon: icons.tasks },
        { to: "/employee/apply-leave", label: "Apply Leave", icon: icons.leaves },
        { to: "/employee/my-leaves", label: "Leave History", icon: icons.leaves },
        { to: "/employee/announcements", label: "Announcements", icon: icons.announcements },
        { to: "/employee/change-password", label: "Change Password", icon: icons.password },
    ];
            ...
            <div className="d-flex min-vh-100 flex-column flex-md-row">
                ...
                <div className="col-12 col-md-9 col-lg-10 d-flex flex-column bg-light min-vh-100">
                    ...
                    <header className="d-none d-md-flex justify-content-between align-items-center bg-white px-4 py-3 border-bottom shadow-sm">
                        <h5 className="text-secondary mb-0 fw-semibold">Employee Workspace</h5>
